package com.epologee.util.drawing {
	...
	public class ShapeDrawings {
		...
		public static function arrow(inLength : Number = 7, inWidth : Number = 14, inColor : uint = 0xFF9900, inAlpha : Number = 1):Shape {
			return Draw.arrow(new Shape(), inLength, inWidth, inColor, inAlpha);
		}
	}
}
