package com.epologee.util.drawing {
	...
	public class SpriteDrawings {
		...
		public static function arrow(inLength : Number = 7, inWidth : Number = 14, inColor : uint = 0xFF9900, inAlpha : Number = 1):Sprite {
			return Draw.arrow(new Sprite(), inLength, inWidth, inColor, inAlpha);
		}

		public static function check(inSize : Number = 7, inTaper:Number = 0, inColor : uint = 0xFF9900, inAlpha : Number = 1):Sprite {
			return Draw.check(new Sprite(), inSize, inTaper, inColor, inAlpha);
		}
	}
}
