package com.epologee.ui.buttons {
	 ...
	 * 
	 */
	[Event(name = "CLICK", type = "com.epologee.ui.buttons.MultiStateEvent")]    

	[Event(name = "MOUSE_DOWN", type = "com.epologee.ui.buttons.MultiStateEvent")]    

	[Event(name = "MOUSE_UP", type = "com.epologee.ui.buttons.MultiStateEvent")]    

	[Event(name = "MOUSE_OUT", type = "com.epologee.ui.buttons.MultiStateEvent")]    

	[Event(name = "MOUSE_OVER", type = "com.epologee.ui.buttons.MultiStateEvent")]    
	...
	public class MultiStateBehavior extends EventDispatcher implements IEnableDisable {
		...
		public function MultiStateBehavior(inButton : MovieClip, inShowInstantly : Boolean = true, inDefaultClickHandler : Function = null) {
			...
			if (!_timeline) {
				logger.error("MultiStateBehavior: param inButton can't be null!");
				//debug stacktrace
				var linesi : uint = 3;
				logger.debug("MultiStateBehavior [stacktrace]:\n" + Error(new Error()).getStackTrace().split("\n").slice(1, linesi + 1).join("\n"));
				return;
			}
			...
			if (inDefaultClickHandler is Function) {
		...
		public function disable() : void {
			...
			_mouseStack.unshift(MultiStateBehavior.MOUSE_OUT);
			processStack();
		}
