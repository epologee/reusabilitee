package com.epologee.ui.text {
	...
	public class FormattedTextField extends TextField {
		...
		public function FormattedTextField(font : String, fontSize : Number = 12, color : uint = 0x000000, bold : Boolean = false, italic : Object = false) {
			super();
			embedFonts = true;
			width = 100;
		...
		public function set letterSpacing(letterSpacing : Number) : void {
			if (styleSheet)
				return;
