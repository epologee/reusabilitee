...
//			handleDebugClick();
		...
		private function handleMouseUp(event : MouseEvent) : void {
			...
			logger.info("new position: .x = " + [_dragging.x + _dragging.parent.x, _dragging.y + _dragging.parent.y].join("; .y = ") + ";");
		}

		private function handleDebugClick(event : MouseEvent = null) : void {
			//			logger.debug("handleDebugClick: "+[mouseX, mouseY]);
...
class ResizeCorner extends Sprite {
	...
	private function stopResize(event : MouseEvent) : void {
		...
		logger.info("new dimensions: .width = " + [_target.width, _target.height].join("; .height = ") + ";");
	}
